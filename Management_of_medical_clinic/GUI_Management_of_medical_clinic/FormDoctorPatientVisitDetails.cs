...
namespace GUI_Management_of_medical_clinic
{
	public partial class FormDoctorPatientVisitDetails : Form
	{
		...
		public FormDoctorPatientVisitDetails(EmployeeModel currentUser, DoctorsDayPlanModel appointment)
		{
			InitializeComponent();
		...
		{
			FormDoctorPatientList formPatientList = new FormDoctorPatientList(currentUser);
			Hide();
