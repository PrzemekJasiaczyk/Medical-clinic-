namespace GUI_Management_of_medical_clinic
{
    partial class FormDoctorsPlanCalendar
    {
        ...
        private void InitializeComponent()
        {
            ...
            // buttonEditPlan
            // 
            buttonEditPlan.Location = new Point(1628, 1012);
            buttonEditPlan.Name = "buttonEditPlan";
            buttonEditPlan.Size = new Size(225, 37);
            buttonEditPlan.TabIndex = 28;
            buttonEditPlan.Text = "Edit";
            buttonEditPlan.UseVisualStyleBackColor = true;
            buttonEditPlan.Click += buttonEditPlan_Click;
            // 
